            ...
            <table class="table table-striped">
                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info me-2" href="<?= base_url('menu/' . $user['restaurant_id']) ?>"><i class="bi bi-eye-fill"></i></a>
                            <a class="btn btn-sm btn-primary me-2" href="<?= base_url('edit/' . $user['restaurant_id']) ?>"><i class="bi bi-pencil-fill"></i></a>
