...
class MenuModel extends Model
{
    ...
    protected $primaryKey = 'name'; // Defines the primary key field of the table for CRUD operations.
    ...
    protected $allowedFields = ['restaurant_id', 'description', 'price', 'kj', 'image', 'type']; 
